Public Class Rpt_Digitacion
    ...
    Private Sub Rpt_Digitacion_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        DdBind(DDLREPORTE, "EXEC DB_WEB.[dbo].[PRG_APP_GESTION_ARCHIVO]  105,'" + CStr(Session("UCO")) + "'", "ID", "RESULTADO")
    End Sub
    ...
    Private Sub BTNGO_Click(sender As Object, e As EventArgs) Handles BTNGO.Click
        ...
        ElseIf DDLREPORTE.SelectedValue.ToString = "113" Then
            P_IMAGENES.Visible = False
            P_DOCTOENCA.Visible = True
            GridBind(GVDOCTOENCA, "EXEC DB_WEB.[dbo].[PRG_APP_GESTION_ARCHIVO] " & DDLREPORTE.SelectedValue.ToString & ",'" & DDLEMPRESA.SelectedValue.ToString() & "','" & DDLTIENDA.SelectedValue.ToString & "','" & TXTNOFACTURAFEL.Text & "','" & CDate(TXTFECHADOCTO.Text).ToString("yyyyMMdd") & "'", "", {"IdEmpresa", "IdSucursal", "NombreSucursal"})
        Else
            P_IMAGENES.Visible = False
            P_DOCTOENCA.Visible = True
    ...
    Private Sub DDLREPORTE_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DDLREPORTE.SelectedIndexChanged
        If DDLREPORTE.SelectedValue.ToString = "113" Then
            PNOFACTURA.Visible = True
        Else
            PNOFACTURA.Visible = False
        End If
    End Sub
End Class