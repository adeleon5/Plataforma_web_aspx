Public Class AdmSeguridad
    ...
    Private Sub BTNSAVNEW_Click(sender As Object, e As EventArgs) Handles BTNSAVNEW.Click
        ...
        If TXTNOM.Text.Length = 0 Or TXTEMA.Text.Length = 0 Then
            ...
            Exit Sub
        End If
        AbrirRecordsetData("EXEC SEGURIDAD 1,'ADMINISTRADOR','" & TXTNOM.Text & "','','" & TXTEMA.Text & "'")
        If nA(0) = 0 Then
            LBLERRMNW.Text = nA(1)
            Exit Sub
        End If
    ...
    Protected Sub BTNADDMENU_Click(sender As Object, e As EventArgs) Handles BTNADDMENU.Click
