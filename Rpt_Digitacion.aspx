            ...
            <div class="w3-col s12 w3-padding w3-mobile">
                <div class="w3-card-4">
                    ...
                    <div class="w3-container w3-padding">
                      ...
                      <asp:DropDownList ID="DDLREPORTE" runat="server" CssClass="w3-input w3-border w3-light-grey w3-round" AutoPostBack="true" ></asp:DropDownList>
                        </p>
                        <p>
                        ...
                        <asp:Panel runat="server" ID="PNOFACTURA" Visible="false"> 
                        <p>
                            <label class="w3-text-black">
                            <b>Número de factura</b></label>
                            <asp:TextBox ID="TXTNOFACTURAFEL" runat="server" CssClass="w3-input w3-border w3-light-gray w3-round"></asp:TextBox>
                        </p>
                        </asp:Panel>
                        <p>
                            <label class="w3-text-black">
